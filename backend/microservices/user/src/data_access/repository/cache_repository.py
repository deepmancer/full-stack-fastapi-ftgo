...
class CacheRepository(BaseRepository):
    ...
    @classmethod
    async def fetch(cls, keys: Union[List[str], str]) -> Union[str, dict, None, List[Union[str, dict, None]]]:
        try:
            ...
            async with cls._data_access.get_or_create_session() as session:
                ...
                deserialized_values = [cls._deserialize_value(value) if value else None for value in values]
    ...
    @classmethod
    async def delete(cls, keys: Union[List[str], str]) -> None:
        try:
