...
from foodzood.backend.microservices.user_management.app.configs.database import Base
...
from backend.microservices.user_management.app.configs.postgres import settings
