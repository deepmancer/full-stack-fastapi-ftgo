...
class PostgresConfig(BaseConfig):
    def __init__(
        ...
        self.db = db or env_var("POSTGRES_DB", default="location_database")
        self.user = user or env_var("POSTGRES_USER", default="location_user")
        self.password = password or env_var("POSTGRES_PASSWORD", default="location_password")
